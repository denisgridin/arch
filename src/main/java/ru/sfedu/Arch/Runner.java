        ...
        try {
            ...
            switch (function) {
                ...
                case getAssessmentById: {
                    return api3.getAssessmentById(ru.sfedu.Arch.lab3.MappedSuperclass.model.Assessment.class, UUID.fromString((String) args.get(Constants.FIELD_ID)));
                }
    ...
    public Result runTablePerClassClassStrategy (String method, HashMap args) {
        try {
            ...
            switch (function) {
                ...
                case getAssessmentById: {
                    return api3.getAssessmentById(ru.sfedu.Arch.lab3.TablePerClass.model.Assessment.class, UUID.fromString((String) args.get(Constants.FIELD_ID)));
                }
                case updateAssessment: {
                    return api3.buildAndUpdateAssessment(args);
                }
