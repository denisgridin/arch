...
@Entity(name = Constants.ENTITY_PRESENTATION_MAP_COLLECTION)
@Table(name = Constants.TABLE_PRESENTATION_MAP_COLLECTION)
...
//    private HashMap marks;
    ...
    public Map<String, String> getSlides () {
        return slides;
    }

    public void setSlides (Map<String, String> items) {
        slides = items;
    }
