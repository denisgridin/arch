package ru.sfedu.Arch.lab4.setCollection.model;
...
@Entity(name = Constants.ENTITY_PRESENTATION)
@Table(name = Constants.TABLE_PRESENTATION_SET_COLLECTION)
public class Presentation implements Serializable {
    ...
    @ElementCollection
    @CollectionTable(
            name = Constants.TABLE_SLIDES_SET_COLLECTION,
...
//    private HashMap marks;
    ...
    public void setSlides (Set<Slide> items) {
        slides = items;
    }
